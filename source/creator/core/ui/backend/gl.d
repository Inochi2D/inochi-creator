...
private {
    ...
    version (OSX)
        char[32] g_GlslVersionString = "#version 330"; // Specified by user or detected based on compile time GL settings.
    else
        char[32] g_GlslVersionString = "#version 130"; // Specified by user or detected based on compile time GL settings.
        ...
        for (int cmd_i = 0; cmd_i < cmd_list.CmdBuffer.Size; cmd_i++) {
            ...
            if (pcmd.UserCallback != null) {
                ...
                if (clip_rect.x < fb_width && clip_rect.y < fb_height && clip_rect.z >= 0.0f && clip_rect.w >= 0.0f) {
                    ...
                    // Ugly hack
                    if (cast(GLuint)(cast(int*)(pcmd.TextureId)) == inGetRenderImage())
